...
Box::Box(const Box& box): x0(box.x0), x1(box.x1), y0(box.y0), y1(box.y1), z0(box.z0), z1(box.z1)
{}

Box::Box(Box&& box): x0(box.x0), x1(box.x1), y0(box.y0), y1(box.y1), z0(box.z0), z1(box.z1)
{}
